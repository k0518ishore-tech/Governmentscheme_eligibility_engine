      ...
      <div class="auth-panel">
        <div style="position:relative;z-index:1;max-width:400px;text-align:center">
          ...
          <p style="color:rgba(255,255,255,0.7);font-size:var(--fs-base);line-height:1.7">
            Join thousands of citizens who use SchemeGuide to find relevant government schemes and check their eligibility.
          </p>
          <div style="display:flex;justify-content:center;gap:var(--space-8);margin-top:var(--space-8)">
            ${[['100+','Schemes'],['9','Categories'],['50K+','Users']].map(([n,l]) => `
              <div>
                <div style="font-size:var(--fs-xl);font-weight:800;color:white">${n}</div>
                <div style="font-size:var(--fs-xs);color:rgba(255,255,255,0.5)">${l}</div>
              </div>
            `).join('')}
          </div>
        </div>
