      ...
      <div class="card-body">
        <div class="flex justify-between items-start mb-3">
          ...
          <button class="save-btn saved" data-id="${scheme.id}"
            onclick="toggleSave(${scheme.id}); setTimeout(() => navigate('saved'), 300)"
        ...
        <div class="flex gap-2">
          ...
          <button class="btn btn-ghost btn-sm" onclick="toggleSave(${scheme.id}); setTimeout(() => navigate('saved'), 300)">
            Remove
          </button>
        </div>
      </div>
