          ...
          <div class="hero-text animate-up">
            ...
            <div class="hero-stats">
              <div>
                ...
                <div class="hero-stat-label">Government Schemes</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div class="hero-stat-label">Users Helped</div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="grid grid-4" style="gap:var(--space-5)">
            ${[
              ...
              { icon: Icons.search, color: 'green', title: 'Scheme Discovery', desc: 'Search and filter through 100+ government schemes across all categories.' },
            ].map(f => `
          ...
          <div class="grid" style="grid-template-columns:repeat(auto-fill,minmax(160px,1fr));gap:var(--space-4)">
            ${CATEGORIES.map(cat => `
              <div class="feature-card text-center" style="cursor:pointer;padding:var(--space-5)"
                ...
                <div style="font-size:var(--fs-xs);color:var(--clr-text-muted);margin-top:var(--space-1)">${cat.count} schemes</div>
              </div>
            `).join('')}
          </div>
        </div>
      ...
      <section class="stats-section">
        <div class="container">
          <div class="grid grid-4 stats-grid" style="gap:var(--space-6)">
            ${[
              { num: '100+', label: 'Government Schemes Indexed' },
              { num: '9', label: 'Scheme Categories' },
              { num: '8', label: 'Departments Covered' },
              { num: '50,000+', label: 'Citizens Helped' },
            ].map(s => `
        ...
        <div class="container">
          <div style="background:linear-gradient(135deg,var(--clr-navy) 0%,#1A4F8A 100%);border-radius:var(--radius-xl);padding:var(--space-12);text-align:center;position:relative;overflow:hidden">
            <div style="position:relative;z-index:1">
              ...
              <p style="color:rgba(255,255,255,0.7);font-size:var(--fs-lg);margin-bottom:var(--space-8)">Join thousands of citizens who discovered government schemes through SchemeGuide.</p>
